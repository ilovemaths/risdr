...
| Real-data fixed dimension | Short argument `d` partially matched `delta` | Added an explicit `d` argument and forwarded it to [`fit_risdr()`](https://ilovemaths.github.io/risdr/reference/fit_risdr.md) |
