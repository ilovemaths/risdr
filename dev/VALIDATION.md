...
successfully and then ran
[`devtools::test()`](https://devtools.r-lib.org/reference/test.html).
The first native test run reported 165 passes and three failures. The
failures identified:
...
Run
[`devtools::document()`](https://devtools.r-lib.org/reference/document.html)
once more if roxygen-generated files differ from the files in this
archive.
